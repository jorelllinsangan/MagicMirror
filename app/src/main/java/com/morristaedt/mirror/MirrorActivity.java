...
//    private View mGroceryList;
    ...
    private TextView mDailyMessageText;
...
//        mGroceryList = findViewById(R.id.grocery_list);
        mDailyMessageText = (TextView) findViewById(R.id.daily_message_text);
...
//        mMoodText = (TextView) findViewById(R.id.mood_text);
    ...
    private void setViewState() {
        ...
        String dailyMessage = DailyMessageModule.getMessage();
...
//        mGroceryList.setVisibility(ChoresModule.makeGroceryListToday() ? View.VISIBLE : View.GONE);
        Log.i("TEST", "setViewState: try to go in");
        if(mConfigSettings.showDailyMessage()){
            Log.i("TEST", "setViewState: Not even here");
            if (dailyMessage.length() == 0) {
                Log.i("TEST", "setViewState: Gone");
                mDailyMessageText.setVisibility(View.GONE);
            } else {
                Log.i("TEST", "setViewState: DUUUDE");
                mDailyMessageText.setVisibility(View.VISIBLE);
                mDailyMessageText.setText(dailyMessage);
            }
        }
