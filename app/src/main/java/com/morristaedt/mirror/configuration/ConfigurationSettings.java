...
public class ConfigurationSettings {
    ...
    private static final String DAILY_MESSAGE = "daily_message";
    ...
    private void readPrefs() {
        ...
        mDailyMessage = mSharedPrefs.getBoolean(DAILY_MESSAGE, false);
    ...
    public void setDailyMessage(boolean show) {
        mDailyMessage = show;
        SharedPreferences.Editor editor = mSharedPrefs.edit();
        editor.putBoolean(DAILY_MESSAGE, show);
        editor.apply();
    }
    ...
    public boolean showDailyMessage() { return mDailyMessage; }
