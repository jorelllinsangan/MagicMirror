...
public class SetUpActivity extends Activity {
    ...
    private CheckBox mDailyMessageCheckbox;
...
//        mMoodDetectionCheckbox.setChecked(mConfigSettings.showMoodDetection());
        ...
        mDailyMessageCheckbox = (CheckBox) findViewById(R.id.daily_message_checkbox);
        mDailyMessageCheckbox.setChecked((mConfigSettings.showDailyMessage()));
    ...
    private void saveFields() {
        ...
        mConfigSettings.setDailyMessage(mDailyMessageCheckbox.isChecked());
